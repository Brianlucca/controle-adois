        ...
        <Card className="bg-[#1A1D24] border-white/5">
            ...
            <CardContent className="space-y-6 pt-6">
                ...
                <div className="flex justify-end">
                    <Button onClick={handleUpdateProfile} disabled={loadingProfile} className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold h-11 px-6">
            ...
            <CardContent className="p-0 divide-y divide-white/5">
                ...
                <div className="flex justify-between p-5 items-center">
                    <div className="flex gap-4 items-center">
                        <div className="p-2.5 bg-slate-800 rounded-xl text-indigo-400"><Moon size={20}/></div>
                        <div>
                ...
                <div className="flex justify-between p-5 items-center">
                    <div className="flex gap-4 items-center">
                        <div className="p-2.5 bg-slate-800 rounded-xl text-emerald-400">{hideValues ? <EyeOff size={20}/> : <Eye size={20}/>}</div>
                        <div>
                ...
                <div className="flex justify-between p-5 items-center">
                    <div className="flex gap-4 items-center">
                        <div className="p-2.5 bg-slate-800 rounded-xl text-amber-400"><Bell size={20}/></div>
                        <div>
        ...
        <Card className="bg-[#1A1D24] border-white/5">
            ...
            <CardContent className="space-y-6">
                <div className="flex justify-between items-center p-4 bg-slate-950 rounded-xl border border-white/5">
                    ...
                    <Button variant="ghost" size="sm" onClick={handleResetPassword} className="text-indigo-400 hover:text-indigo-300 hover:bg-white/5">Redefinir Senha</Button>
                </div>

                <div className="border border-red-500/20 rounded-xl overflow-hidden bg-red-500/5 p-6 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <Button variant="destructive" size="sm" onClick={handleDeleteAccount} disabled={deletingAccount} className="bg-red-600 hover:bg-red-700 font-bold">
