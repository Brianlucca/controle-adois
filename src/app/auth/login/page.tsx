...
export default function LoginPage() {
  ...
  async function handleForgotPassword(e: React.FormEvent) {
    ...
    try {
      ...
      setForgotMessage({
        type: "success",
        text: "Se o e-mail estiver cadastrado, você receberá um link de recuperação.",
      });
      setForgotEmail("");
    } catch (error) {
      const errorCode = error instanceof FirebaseError ? error.code : "";
  ...
  return (
    <div className="auth-page fixed inset-0 z-50 grid h-screen w-full overflow-hidden bg-[#fbfaf7] font-sans lg:grid-cols-[.92fr_1.08fr]">
      <div className="relative flex h-full flex-col items-center justify-center overflow-y-auto bg-[#fbfaf7] px-6 py-12 lg:px-16 xl:px-24">
        <div className="w-full max-w-[400px] mx-auto space-y-8">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="mt-2 h-12 w-full rounded-xl bg-[#635bff] text-base font-bold text-white hover:bg-[#544ce0]"
            >
              {loading ? (
        ...
        <div className="relative z-10 h-full flex flex-col justify-end p-16 xl:p-24 text-white max-w-2xl">
          <div className="mb-8">
            ...
            <p className="text-lg text-slate-300 leading-relaxed font-light">
              Visualize seus gastos, planeje investimentos e alcance a liberdade
          ...
          <div className="bg-white rounded-2xl w-full max-w-md p-6 shadow-2xl scale-100 animate-in zoom-in-95 duration-200 relative">
            ...
            <div className="mb-6">
              ...
              <p className="text-slate-500 text-sm mt-1">
                Digite seu e-mail e nós enviaremos um link de recuperação se a
                conta existir.
              </p>
            </div>
            ...
            <form onSubmit={handleForgotPassword} className="space-y-4">
              ...
              {forgotMessage && (
                <div
                  className={`p-4 rounded-lg flex items-start gap-3 border-l-4 text-sm ${
