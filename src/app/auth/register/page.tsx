          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <Lock
                    className={`absolute left-3 top-3.5 ${passwordsMatch && confirmPassword ? "text-emerald-600" : "text-slate-400"}`}
                    size={18}
                  />
                  <Input
                    type={showPassword ? "text" : "password"}
        ...
        <div className="relative z-10 h-full flex flex-col justify-end p-16 xl:p-24 text-white max-w-2xl">
          <div className="mb-8">
            ...
            <p className="text-lg text-slate-300 leading-relaxed font-light">
              Reúna receitas, despesas, contas e investimentos em um espaço
              compartilhado, claro e fácil de acompanhar.
            </p>
          </div>
